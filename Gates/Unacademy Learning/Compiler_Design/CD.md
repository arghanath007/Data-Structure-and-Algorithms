...
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/fee7dba0-1e59-4a02-a280-4afdb5402d5f)

* Example.
* **(A + B)** is both physically and logically they are **same** as in-between they are not changing.
* **E and H** are **same**.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/bc0c940c-ebbc-4fff-a6ad-33f936c2b69d)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/5870fdfb-0191-4b83-b309-2959e141f1e6)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/0ddea0e8-0e2a-46c3-8f1a-a9e90ff8d537)

* No. of nodes -> 10
* No. of edges -> 10
* **Minus(-)** there doesn't mean that we will always cancel.
* [**IMPORTANT**]
* For a c-program accessing x[i][j][k] the following intermediate code is generated by a compiler. Assume integer 4-bytes, character is 1-byte.
* Which one of the following is correct c-declaration for the above data?

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/e8022107-ce28-46b1-8d67-70d940b50071)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/7ac13c98-86ec-45bd-8dc5-eed0a2d33cfd)

* Example.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/504066dc-4ca1-4f2d-8a06-460eaef8009c)

* Rows -> 0 to 10 -> 11
* Columns -> 0 to 15 -> 16
* 2D arrays -> 0 to 8 -> 9.
* By mentioning **c-program** the default is **row-wise major**.
* 2D array size -> 11 * 16.
* We have **0 to 8** or **9** 2D arrays.
* We want to go to **ith 2D** so before **i** cross all.
* Before **ith 2D** we have **i - 0** 2Ds.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/f9ce7997-4bd4-4dd9-9c5b-f4dcac1101cb)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/3b66fd2a-e94a-441d-81ca-12306fc27687)

* **3-address code** will support **1D format**. It don't support **2D and 3D formats** directly. We have to go on expanding.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/32de7353-232b-4a0a-9c86-c287f50ac13e)

* Option **A** is the **answer**.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/075ab4b4-9aa5-4eef-a00d-314d5ff96b36)

* [**IMPORTANT**]

## runtime-environment-part-ii (20) [13th Oct 2023]

* Intermediate code representation is 4 or 5 ways -> 3-address code, postfix notation, syntax tree, DAG, SSA.
...
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/a91cb7d8-aca1-4b9e-8c02-4b5166716e6b)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/24a50984-6b7d-4de0-8829-21bed73dbb53)

* Example.
* Moving to the **right side** is **push** operation.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/fd30f991-1065-4eed-9933-154a583cdf9a)

* Op1, Op2 -> Operand1 and Operand2.
* Op -> Operator
* result -> temporary variable.
* We have **4-people** so it is called as **Quadraple representation**.
* **b * c** will be done in a **temporary variable(t1)**.
* **x =  t5**.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/026cb5a2-1457-485b-b53b-67c26df04482)

* Result is going to **x**.
* So **x** will be in the **result** column.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/7deae9cc-f321-4739-b9e9-12584fd5bcb9)

* **x =  t5** is the only **difference**.
* Result should finally go to **x**. So **result** is **x**.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/ca7d9d46-ee1c-418f-8f73-30c779d332f4)

* Quadrapole representation as **4-people/columns** are there. [**IMPORTANT**]
* Table means **array** only.
* In **Quadrapole**, we can move the **result** wherever we want. There is a flexibility there. [Advantage]
* In **Quadrapole**, **space** is not **saved**.  [Disadvantage]

### Triple

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/77955b89-ab32-4633-8068-d6fb46276e6b)

* In **Triple** we have **three(3) columns**. Leave **S.NO** they are by default sequence no. of array.
* **Triple** is better for **space** point of view. [Advantage] 
* The **only disadvantage** is that the **result** is fixed to that particular **row only**. We cannot move the **result** wherever we want. No flexibility there. [Disadvantage]

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/b1aa4197-5f8e-4a70-aec4-e65d84e8929e)

* For **3** it is **a + t1** but in **triple** we didn't use **temporary variables** so **t1** is **1** only as the result of **statement '1'** is stored in **row '1'**.

![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/b188c5e6-51bd-4121-8268-c7092eca6aa5)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/dfe79627-10f5-4e28-88b2-4d249926de72)
![image](https://github.com/arghanath007/Data-Structure-and-Algorithms/assets/54589605/3ba96c0a-b278-4f6b-a57d-c0574f319d23)

* 1 -> t1 -> Stored the statement '1' result.
* 2 -> t2 -> Stored the statement '2' result.
* 3 -> t3 -> Stored the statement '3' result.
* 4 -> t4 -> Stored the statement '4' result.
* 5 -> t5 -> Stored the statement '5' result.
* 6 -> t6 -> Stored the statement '6' result.
* [**IMPORTANT**]
